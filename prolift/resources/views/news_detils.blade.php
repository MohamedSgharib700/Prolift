@extends('master_page')
 ...
 @section('content')
			...
			<section class="section section-parallax parallax custom-parallax-medium-padding m-none" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="{{asset('imgAboutUS/' . $titlePage->image)}}">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<section class="section section-no-border background-color-light m-none pb-none">
				<div class="container">
					<div class="row custom-sm-flex-order-2">
						<div class="col-sm-10 col-md-8 col-sm-offset-2 col-md-offset-1">
							<article class="custom-post-style-2">
								...
								<!--	<span class="post-info">
										...
										<span class="date-day text-color-dark font-weight-semibold text-lg">{{$postss->days}}</span>
										<span class="date-month text-color-dark font-weight-semibold">{{$postss->months}}</span>
									</span> -->
								<!--<span class="post-info">
										<img src="img/demos/finance/icons/custom-icon-4.png" alt class="img-responsive mb-sm" />
									<span class="date-day text-color-dark font-weight-semibold text-lg">16</span>
										<span class="fb-comments-count" data-href="http://localhost/Prolift/public/news_detils">Comments</span>
									</span>
									<span class="post-info">
					...
					<img style="height:400px;width:600.5px;" src="{{asset('imgBlog/' . $postss->images)}}" alt class="img-responsive mb-xlg" />
								<p class="custom-text-color-1">{!! $postss->contents !!}</p>

								
								
								<!--<div class="post-links">
									<a class="custom-item-divider-1 text-decoration-none text-uppercase text-color-dark font-weight-semibold custom-primary-hover pull-left mr-xlg" href="demo-finance-news-detail.html"><i class="fa fa-long-arrow-left text-color-primary mr-xs"></i> Prev</a>
									<a class="text-decoration-none text-uppercase text-color-dark font-weight-semibold custom-primary-hover pull-left" href="demo-finance-news-detail.html">Next <i class="fa fa-long-arrow-right text-color-primary ml-xs"></i></a>
						...
						<div class="col-md-9">
							<div class="post-block post-leave-comment custom-border-none custom-background-1 custom-section-spacement-1 m-none">
								<h4 class="text-uppercase font-weight-bold text-color-dark text-lg mb-md"></h4>
