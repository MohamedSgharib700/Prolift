                ...
                <div class="middle-content">
                    <div class="row no-m-t no-m-b">
                        <div class="row">
                            ...
                            <form method="POST" action="{{route('clint',['clint'=> $clint->id])}}" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              {{ csrf_field() }}
                              ...
                              @endif
                                ...
                                <div class="loading-sub" style="display: none;">
                                 ...
                                 <div class="file-field col s6">
                                    <div class="btn teal lighten-1">
                                        <span>File</span>
                                        <input name="image" type="file" value="{{$clint->image}}">
                                    </div>
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" required="" name="title" type="text" value="{{$clint->title}}">
                                    <label for="name">Name</label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                    <input class="validate" id="name" required name="specialty" type="text" value="{{$clint->specialty}}">
