                        ...
                        <div class="row">
                            <div class="card">
                                 <div class="card-content">
                                    <span class="card-title">Post Add</span>
                              <div class="row">
                            ...
                            <form method="POST" action="add" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              ...
                              @endif
                                ...
                                <div class="loading-sub" style="display: none;">
                                 ...
                                 <div class="file-field col s6">
                                    <div class="btn teal lighten-1">
                                        <span>File</span>
                                        <input name="images" required type="file" value="">
                                    </div>
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="titles" required type="text" value="">
                                    <label for="name">Title</label>
                                    <label class="error"></label>
                                </div>

                                <div class="input-field col s6">
                                <input class="validate" id="name" name="custom_url" required type="text" value="">
    ...
    <td></td>
     ...
     <td>
                               ...
                               <div class="input-field col s12">
                                <textarea required class="validate" id="desc" name="desc" type="text" rows="5">
