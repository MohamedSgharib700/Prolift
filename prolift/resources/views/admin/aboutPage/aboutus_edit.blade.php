                ...
                <div class="middle-content">
                    <div class="row no-m-t no-m-b">
                        <div class="row">
                            ...
                            <form method="POST" action="{{route('about',['about'=> $about->id]) }}" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              {{ csrf_field() }}
                              @if(count($errors)>0)
                              ...
                              @endif
                                ...
                                <div class="loading-sub" style="display: none;">
                                 ...
                                 <div class="file-field col s6">
                                    <div class="btn teal lighten-1">
                                        <span>File</span>
                                        <input name="images" type="file" value="{{$about->images}}">
                                    </div>
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="titles" type="text" value="{{$about->titles}}">
