                ...
                <div class="middle-content">
                    <div class="row no-m-t no-m-b">
                        <div class="row">
                            ...
                            <form method="POST" action="{{route('product',['product'=> $product->id]) }}" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              {{ csrf_field() }}
                              ...
                              @endif
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="title" type="text" required value="{{$product->title}}">
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="custom_url" type="text" required value="{{$product->custom_url}}">
