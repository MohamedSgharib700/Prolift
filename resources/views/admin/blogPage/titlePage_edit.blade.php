                ...
                <div class="middle-content">
                    <div class="row no-m-t no-m-b">
                        <div class="row">
                            ...
                            <form method="POST" action="{{route('title',['title'=> $title->id]) }}" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                ...
                                <div class="loading-sub" style="display: none;">
                                 ...
                                 <div class="file-field col s6">
                                    <div class="btn teal lighten-1">
                                        <span>File</span>
                                        <input name="image" type="file" value="{{$title->image}}">
                                    </div>
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="title" type="text" value="{{$title->title}}">
