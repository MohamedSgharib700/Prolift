                            ...
                            <form method="POST" action="add" accept-charset="UTF-8" class="ajax-form-request" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                ...
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="name" type="text" value="">
                                    <label for="name">Name</label>
                                    <label class="error"></label>
                                </div>

                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="about" type="text" value="">
                                    <label for="name">About</label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="function" type="text" value="">
                                    <label for="name">Function </label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                <input class="validate" id="name" name="facebook" type="text" value="">
                                    <label for="name">URL Facebook </label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                <input class="validate" id="name" name="twitter" type="text" value="">
                                    <label for="name">URL Twitter </label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                <input class="validate" id="name" name="linkedin" type="text" value="">
                                    <label for="name">URL Linkedin </label>
                                    <label class="error"></label>
                                </div>
                                <div class="input-field col s6">
                                    <input class="validate" id="name" name="google" type="text" value="">
